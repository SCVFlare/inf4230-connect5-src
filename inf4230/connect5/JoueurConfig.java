...
public class JoueurConfig extends javax.swing.JPanel {
    ...
    public Joueur getJoueur(){
        ...
        if(interneRB.isSelected())
            return new BotInterne();
        if(externRB.isSelected()){
            try{
                BotCmd j = new BotCmd(pathTF.getText());
        ...
        if(remoteRB.isSelected()){
            try{
                BotDistant j = new BotDistant(hostTF.getText(), Integer.parseInt(portTF.getText()));
                //j.setDebug(debugCheckBox.isSelected());
                return j;
            }catch(Exception e){
                e.printStackTrace();
    ...
    private void initComponents() {
        ...
        interneRB.setText("Bot interne (classe inf4230.connect5.ia.BotInterne)    ");
        ...
        externRB.setText("Bot externe (interface stdin / stdout - classe inf4230.connect5.BotCmd)   ");
        ...
        pathTF.setText("/home/user/inf4230/tp2/joueur");
        ...
        remoteRB.setText("Bot distant (interface socket - classe inf4230.connect5.BotDistant)  ");
